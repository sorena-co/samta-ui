...
import ir.donyapardaz.niopdc.web.filter.LocalizationEntityFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    @Bean
    public LocalizationEntityFilter modifyRequestEntityFilter() {
        return new LocalizationEntityFilter();
    }
