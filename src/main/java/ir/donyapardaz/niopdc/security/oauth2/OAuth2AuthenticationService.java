package ir.donyapardaz.niopdc.security.oauth2;
...
public class OAuth2AuthenticationService {
    ...
    public void logout(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) {
        ...
        String refreshCookieValue = OAuth2CookieHelper.getRefreshTokenValue(refreshTokenCookie);
        authorizationClient.deleteRefreshToken(refreshCookieValue);
