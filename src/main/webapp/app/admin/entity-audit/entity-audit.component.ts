...
export class EntityAuditComponent implements OnInit {
    ...
    loadChanges() {
        this.loading = true;
        this.service.findByEntity(this.microServiceName, this.selectedEntity, this.username, this.selectedLimit, this.startTime, this.endTime)
            .subscribe((audits) => {
    ...
    openChange(audit: EntityAuditEvent) {
        if (audit.commitVersion < 2) {
            ...
            modalRef.componentInstance.openChange(this.microServiceName, audit);
        }
    }
