...
import {CustomerPerson} from '../../../entities/sell-contract';
...
export class SellContractCustomerPersonSelectorComponent implements OnInit {
    ...
    @Input() sellContractProducts: CustomerPerson[];
