...
export class CustomerTypeProductConsumptionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.customerTypeProductConsumptionService.query(this.customerTypeId, {
    ...
    clear() {
        ...
        this.router.navigate(['customer-type/' + this.customerTypeId + '/customer-type-product-consumption'], {
            queryParams: {
                page: this.page,
    ...
    search() {
        ...
        if (this.customerTypeProductConsumption.productId) {
            this.currentSearch += 'product.id☼' + this.customerTypeProductConsumption.productId + '&';
        }
    ...
    ngOnInit() {
        ...
        this.customerTypeService.find(this.customerTypeId).subscribe(
            (customerType: HttpResponse<CustomerType>) => {
