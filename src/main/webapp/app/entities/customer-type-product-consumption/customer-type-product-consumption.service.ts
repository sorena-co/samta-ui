...
export class CustomerTypeProductConsumptionService {
    ...
    query(customerTypeId: any, req?: any): Observable<HttpResponse<CustomerTypeProductConsumption[]>> {
        const options = createRequestOption(req);
        return this.http.get<CustomerTypeProductConsumption[]>(this.resourceCustomerTypeUrl + '/' + customerTypeId + '/customer-type-product-consumptions' , { params: options, observe: 'response' })
