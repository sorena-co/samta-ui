...
export class VoucherMasterComponent implements OnInit, OnDestroy {
    ...
    search() {
        ...
        if (this.voucherMaster.confirmDate) {
            this.currentSearch += 'confirmDate→' + this.voucherMaster.confirmDate.toISOString() + '&';
        }
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('samtagatewayApp.voucherMaster.home.title').subscribe((title) => {
