...
export const voucherMasterRoute: Routes = [
    ...
    {
        path: 'voucher-master/:voucherMasterId/report',
...
export const voucherMasterPopupRoute: Routes = [
    ...
    {
        path: 'voucher-master/:id/confirm',
