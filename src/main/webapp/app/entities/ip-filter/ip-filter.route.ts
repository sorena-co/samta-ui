...
export const ipFilterRoute: Routes = [
    {
        path: 'user-management/:username/ip-filter',
        ...
        data: {
            ...
            pageTitle: 'samtagatewayApp.ipFilter.home.title'
        },
...
export const ipFilterPopupRoute: Routes = [
    ...
    {
        path: 'ip-filter/:id/:username/edit',
        component: IpFilterPopupComponent,
        data: {
