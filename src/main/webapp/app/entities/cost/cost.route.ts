...
export const costRoute: Routes = [
    {
        path: 'cost-group/:costGroupId/cost',
        ...
        path: 'cost-group/:costGroupId/cost/:costId/cost',
        component: CostComponent,
        resolve: {
            'pagingParams': CostResolvePagingParams
        },
...
export const costPopupRoute: Routes = [
    {
        path: 'cost-new/cost-group/:costGroupId',
    ...
    {
        path: 'cost/:id/cost-group/:costGroupId/edit',
        component: CostPopupComponent,
        data: {
    ...
    {
        path: 'cost/:id/cost-group/:costGroupId/:view',
        component: CostPopupComponent,
        data: {
