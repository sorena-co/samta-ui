...
export class PaymentComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.paymentService.query({
            personName: this.payment.personName,
    ...
    search() {
        this.page = 0;
        this.currentSearch = '';
        if (this.payment.customerName) {
            this.currentSearch += 'customer|name$' + this.payment.customerName + '&';
        }
        ...
        if (this.payment.amount) {
            this.currentSearch += 'amount☼' + this.payment.amount + '&';
        }
