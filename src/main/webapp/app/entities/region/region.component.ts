...
export class RegionComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.params.subscribe((params) => {
            ...
            if (this.regionId && (!this.locations || this.locations.length <= 0))
                this.locationService.queryForRegion().subscribe(
                    (res) => {
                        this.locations = res.body;
                        this.locations = this.locations.filter((l) => l.level === 2);
    ...
    loadParent() {
        if (!this.regionId) {
            ...
            this.regionService.find(this.regionId).subscribe(
                (region) => {
