...
export const dayDepotServiceOilTankRoute: Routes = [
    {
        path: 'main-day-depot/:mainDayDepotId/day-depot/:dayDepotId/day-depot-service-oil-tank',
...
export const dayDepotServiceOilTankPopupRoute: Routes = [
    {
        path: 'day-depot-service-oil-tank-new/:dayDepotId',
    ...
    {
        path: 'day-depot-service-oil-tank/:id/day-depot/:dayDepotId/:type',
        component: DayDepotServiceOilTankPopupComponent,
        data: {
    ...
    {
        path: 'day-depot-service-oil-tank/:id/delete',
    ...
    {
        path: 'day-depot-service-oil-tank/:id/day-depot/:dayDepotId/:view',
        component: DayDepotServiceOilTankPopupComponent,
        data: {
    ...
    {
        path: 'day-depot-service-oil-tank/full-end-measurement/:id',
