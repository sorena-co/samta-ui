...
export class LoanPaymentDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.loanService.query()
            .subscribe((res: HttpResponse<Loan[]>) => { this.loans = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
        this.billItemService.query()
            .subscribe((res: HttpResponse<BillItem[]>) => { this.billitems = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackBillItemById(index: number, item: BillItem) {
        return item.id;
    }
}
    ...
    ngOnInit() {
        this.routeSub = this.route.params.subscribe((params) => {
            if ( params['id'] ) {
                ...
                this.loanPaymentPopupService
                    .open(LoanPaymentDialogComponent as Component);
            }
        });
    }
