...
export class LoanPaymentService {
    ...
    private resourceUrl =  SERVER_API_URL + 'niopdcaccounting/api/loan-payments';
    ...
    query(req?: any): Observable<HttpResponse<LoanPayment[]>> {
        const options = createRequestOption(req);
        return this.http.get<LoanPayment[]>(this.resourceUrl, { params: options, observe: 'response' })
    ...
    private convertItemFromServer(loanPayment: LoanPayment): LoanPayment {
        ...
        copy.data = this.dateUtils
            .convertDateTimeFromServer(loanPayment.data);
        return copy;
    }
    ...
    private convert(loanPayment: LoanPayment): LoanPayment {
        ...
        copy.data = this.dateUtils.toDate(loanPayment.data);
        return copy;
    }
}
