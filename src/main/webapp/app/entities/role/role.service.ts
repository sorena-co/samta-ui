...
export class RoleService {
    ...
    readListByUserType(userType?:any,req?: any): Observable<HttpResponse<Role[]>> {
        const options = createRequestOption(req);
        return this.http.get<Role[]>(this.resourceUrl + `/read/${userType}`, {params: options, observe: 'response'})
            .map((res: HttpResponse<Role[]>) => this.convertArrayResponse(res));
    }
