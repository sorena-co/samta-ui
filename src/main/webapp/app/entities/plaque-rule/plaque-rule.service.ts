...
export class PlaqueRuleService {
    ...
    query( plaqueId: any, req?: any): Observable<HttpResponse<PlaqueRule[]>> {
        const options = createRequestOption(req);
        return this.http.get<PlaqueRule[]>(this.resourcePlaqueUrl + '/' + plaqueId + '/plaque-rules' , { params: options, observe: 'response' })
