...
export const plaqueRuleRoute: Routes = [
    {
        path: 'plaque/:plaqueId/plaque-rule',
        ...
        data: {
            ...
            pageTitle: 'samtagatewayApp.plaqueRule.home.title'
        },
