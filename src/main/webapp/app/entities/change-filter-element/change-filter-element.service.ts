...
export class ChangeFilterElementService {
    ...
    private resourceUrl =  SERVER_API_URL + 'niopdcao/api/change-filter-elements';

    private resourceRequestFilterElementUrl =  SERVER_API_URL + 'niopdcao/api/request-filter-elements';
    ...
    private convertItemFromServer(changeFilterElement: ChangeFilterElement): ChangeFilterElement {
        ...
        copy.lastChangeDate = this.dateUtils
            .convertDateTimeFromServer(changeFilterElement.lastChangeDate);
        return copy;
    }
