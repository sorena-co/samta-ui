...
export class LiteratureVolumeOilTankComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.serviceOilTankService.queryByOilTankId(this.oilTankId).subscribe(
            (res) => {
        ...
        this.oilTankService.find(this.oilTankId).subscribe(
            (oilTank) => {
                this.oilTank = oilTank.body;
                if (this.serviceOilTankId != null) {
                    this.serviceOilTankService.find(this.serviceOilTankId).subscribe(
                        (serviceOilTank) => {
