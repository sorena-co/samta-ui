...
export const literatureVolumeOilTankRoute: Routes = [
    {
        path: 'oil-tank/:oilTankId/literature-volume-oil-tank',
    ...
    {
        path: 'oil-tank/:oilTankId/service-oil-tank/:serviceOilTankId/literature-volume-oil-tank',
        component: LiteratureVolumeOilTankComponent,
        resolve: {
            'pagingParams': LiteratureVolumeOilTankResolvePagingParams
        },
...
export const literatureVolumeOilTankPopupRoute: Routes = [
    {
        path: 'literature-volume-oil-tank-new/oil-tank/:oilTankId',
    ...
    {
        path: 'literature-volume-oil-tank-new/service-oil-tank/:serviceOilTankId',
        component: LiteratureVolumeOilTankPopupComponent,
        data: {
            authorities: ['ROLE_ADMIN', 'CREATE_LITERATURE_VOLUME_OIL_TANK'],
            pageTitle: 'samtagatewayApp.literatureVolumeOilTank.home.title'
    ...
    {
        path: 'literature-volume-oil-tank/:id/:parent/:parentId/edit',
        component: LiteratureVolumeOilTankPopupComponent,
        data: {
    ...
    {
        path: 'literature-volume-oil-tank/:id/delete',
    ...
    {
        path: 'literature-volume-oil-tank/:id/:parent/:parentId/:view',
        component: LiteratureVolumeOilTankPopupComponent,
        data: {
