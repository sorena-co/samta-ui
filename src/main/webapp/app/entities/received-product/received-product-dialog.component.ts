...
export class ReceivedProductDialogComponent implements OnInit {
    ...
    save() {
        ...
        if (this.receivedProduct.id !== undefined) {
            ...
            this.subscribeToSaveResponse(
                this.receivedProductService.create(this.receivedProduct));
        }
    }
    ...
    private subscribeToSaveResponse(result: Observable<HttpResponse<ReceivedProduct>>) {
        result.subscribe((res: HttpResponse<ReceivedProduct>) =>
            this.onSaveSuccess(res.body), (res: HttpErrorResponse) => this.onSaveError());
    }

    private onSaveSuccess(result: ReceivedProduct) {
