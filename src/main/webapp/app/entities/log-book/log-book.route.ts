...
export const logBookRoute: Routes = [
    {
        path: 'main-day-depot/:mainDayDepotId/day-depot/:dayDepotId/log-book',
        ...
        path: 'main-day-operation/:mainDayOperationId/day-depot/:dayDepotId/log-book',
        component: LogBookComponent,
        resolve: {
            'pagingParams': LogBookResolvePagingParams
        },
