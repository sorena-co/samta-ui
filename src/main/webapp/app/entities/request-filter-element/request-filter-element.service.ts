...
export class RequestFilterElementService {
    ...
    private resourceUrl =  SERVER_API_URL + 'niopdcao/api/request-filter-elements';
    ...
    query(req?: any): Observable<HttpResponse<RequestFilterElement[]>> {
        const options = createRequestOption(req);
        return this.http.get<RequestFilterElement[]>(this.resourceUrl, { params: options, observe: 'response' })
    ...
    private convertItemFromServer(requestFilterElement: RequestFilterElement): RequestFilterElement {
        ...
        copy.lastChangeDate = this.dateUtils
            .convertDateTimeFromServer(requestFilterElement.lastChangeDate);
        return copy;
    }
