...
export class PersonComponent implements OnInit, OnDestroy {
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/person' + (this.companyId ? +'/' + this.companyId + '/stakeholder' : '')], {
            queryParams: {
                page: this.page,
    ...
    search() {
        ...
        if (this.person.status) {
            this.currentSearch += 'status#VerifyStatus.' + this.person.status + '&';
        }
    ...
    ngOnInit() {
        ...
        this.activatedRoute.params.subscribe((param) => {
            ...
            if (this.companyId) {
                this.personService.find(this.companyId).subscribe(
                    (res) => {
