...
export class CurrencyComponent implements OnInit, OnDestroy {
    ...
    clear() {
        ...
        this.currency.isNationalCurrency = null;
        this.loadAll();
    }
    ...
    search() {
        this.page = 0;
        this.currentSearch = '';
        if (this.currency.title) {
            this.currentSearch += 'title$' + this.currency.title + '&';
        }
        if (this.currentSearch.length > 0) {
            this.currentSearch = this.currentSearch.substring(0, this.currentSearch.length - 1);
        }
        if (this.currency.isNationalCurrency) {
            this.currentSearch += 'isNationalCurrency;' + this.currency.isNationalCurrency + '&';
        }
        this.router.navigate(['/currency'], {
            queryParams: {
