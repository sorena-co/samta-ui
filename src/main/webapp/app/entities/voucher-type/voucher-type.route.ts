...
export const voucherTypeRoute: Routes = [
    {
        path: 'voucher-type-group/:voucherTypeGroupId/voucher-type',
        ...
        data: {
            ...
            pageTitle: 'samtagatewayApp.voucherType.home.title'
        },
...
export const voucherTypePopupRoute: Routes = [
    {
        path: 'voucher-type-new/:voucherTypeGroupId',
