...
export class RequestTestResultComponent implements OnInit, OnDestroy {
    ...
    constructor(private requestTestResultService: RequestTestResultService,
        ...
        this.requestTestResult.isSend = null;
        ...
        for (const key of x) {
            ...
            if (value.length > 1) {
                if (value[0].indexOf('.') > 0) {
                    ...
                    this.requestTestResult[value[0]] = Boolean(value[1]);
                } else {
    ...
    search() {
        ...
        if (this.requestTestResult.date) {
            this.currentSearch += 'date→' + this.requestTestResult.date.toISOString() + '&';
        }
        if (this.requestTestResult.sampleValue) {
            this.currentSearch += 'sampleValue☼' + this.requestTestResult.sampleValue + '&';
        }
        if (this.requestTestResult.oilTankInventory) {
            this.currentSearch += 'oilTankInventory☼' + this.requestTestResult.oilTankInventory + '&';
        }
        if (this.requestTestResult.sourceOilTankNumber) {
            this.currentSearch += 'sourceOilTankNumber$' + this.requestTestResult.sourceOilTankNumber + '&';
        }
        if (this.requestTestResult.isSend) {
            this.currentSearch += 'isSend;' + this.requestTestResult.isSend + '&';
        }
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('samtagatewayApp.requestTestResult.home.title').subscribe((title) => {
