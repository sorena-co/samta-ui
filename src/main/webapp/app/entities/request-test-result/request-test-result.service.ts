...
export class RequestTestResultService {
    ...
    private resourceUrl =  SERVER_API_URL + 'niopdcao/api/request-test-results';
    ...
    query(req?: any): Observable<HttpResponse<RequestTestResult[]>> {
        const options = createRequestOption(req);
        return this.http.get<RequestTestResult[]>(this.resourceUrl, { params: options, observe: 'response' })
    ...
    private convertItemFromServer(requestTestResult: RequestTestResult): RequestTestResult {
        ...
        copy.date = this.dateUtils
            .convertDateTimeFromServer(requestTestResult.date);
        return copy;
    }
