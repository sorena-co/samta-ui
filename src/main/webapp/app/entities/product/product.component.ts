...
export class ProductComponent implements OnInit, OnDestroy {
        ...
        for (const key of x) {
            ...
            if (value.length > 1) {
                if (value[0].indexOf('.') > 0) {
                    ...
                    this.product[value[0]] = Number(value[1]);
                } else {
                    this.product[value[0]] = value[1];
                }
            }
        }
    }
    ...
    clear() {
        ...
        this.product.hasContainer = null;
        this.loadAll();
    }
    ...
    search() {
        ...
        if (this.product.productGroupId) {
            this.currentSearch += 'productGroup.id☼' + this.product.productGroupId + '&';
        }
        if (this.product.productUnitId) {
            this.currentSearch += 'productUnit.id☼' + this.product.productUnitId + '&';
        }
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('samtagatewayApp.product.home.title').subscribe((title) => {
