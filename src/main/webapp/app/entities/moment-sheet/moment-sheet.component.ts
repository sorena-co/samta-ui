...
export class MomentSheetComponent implements OnInit, OnDestroy {
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/moment-sheets'], {queryParams: {page: this.page, sort: this.predicate + ',' + (this.reverse ? 'desc' : 'asc')}});
        this.loadAll();
    }
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('samtagatewayApp.momentSheet.home.title').subscribe((title) => {
