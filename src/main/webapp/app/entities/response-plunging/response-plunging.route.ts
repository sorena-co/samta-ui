...
export const responsePlungingRoute: Routes = [
    {
        path: 'request-plunging/:requestPlungingId/response-plunging',
...
export const responsePlungingPopupRoute: Routes = [
    {
        path: 'response-plunging-new/:requestPlungingId',
    ...
    {
        path: 'response-plunging/:id/edit',
        component: ResponsePlungingPopupComponent,
        data: {
    ...
    {
        path: 'response-plunging/:id/delete',
    ...
    {
        path: 'response-plunging/:id/:view',
        component: ResponsePlungingPopupComponent,
        data: {
