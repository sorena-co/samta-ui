...
export const mainAuthorityRoute: Routes = [
    {
        path: 'parent-authority/:parentAuthorityId/main-authority',
        ...
        data: {
            ...
            pageTitle: 'samtagatewayApp.mainAuthority.home.title'
        },
...
export const mainAuthorityPopupRoute: Routes = [
    {
        path: 'main-authority-new/:parentAuthorityId',
