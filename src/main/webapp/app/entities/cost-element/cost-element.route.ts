...
export const costElementRoute: Routes = [
    {
        path: 'cost-group/:costGroupId/cost-element',
        ...
        data: {
            ...
            pageTitle: 'samtagatewayApp.costElement.home.title'
        },
...
export const costElementPopupRoute: Routes = [
    {
        path: 'cost-element-new/cost-group/:costGroupId',
    ...
    {
        path: 'cost-element-new/cost-group/:costGroupId/cost/:costId',
        component: CostElementPopupComponent,
        data: {
            authorities: ['ROLE_ADMIN', 'CREATE_COST_ELEMENT'],
            pageTitle: 'samtagatewayApp.costElement.home.title'
