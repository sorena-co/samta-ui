...
export class CleaningReportOilTankService {
    ...
    private resourceUrl =  SERVER_API_URL + 'niopdcao/api/cleaning-report-oil-tanks';
    ...
    query(req?: any): Observable<HttpResponse<CleaningReportOilTank[]>> {
        const options = createRequestOption(req);
        return this.http.get<CleaningReportOilTank[]>(this.resourceUrl, { params: options, observe: 'response' })
    ...
    private convertItemFromServer(cleaningReportOilTank: CleaningReportOilTank): CleaningReportOilTank {
        ...
        copy.registerDate = this.dateUtils
            .convertDateTimeFromServer(cleaningReportOilTank.registerDate);
        return copy;
    }
