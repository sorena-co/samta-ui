...
export const sendContainerProductRoute: Routes = [
    {
        path: 'main-day-depot/:mainDayDepotId/day-depot-container/:dayDepotContainerId/send-container-product',
...
export const sendContainerProductPopupRoute: Routes = [
    {
        path: 'send-container-product-new/:dayDepotContainerId',
    ...
    {
        path: 'send-container-product/:id/edit',
        component: SendContainerProductPopupComponent,
        data: {
    ...
    {
        path: 'send-container-product/:id/delete',
    ...
    {
        path: 'send-container-product/:id/:view',
        component: SendContainerProductPopupComponent,
        data: {
