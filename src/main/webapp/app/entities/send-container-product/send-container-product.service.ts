...
export class SendContainerProductService {
    ...
    query(dayDepotContainerId: any, req?: any): Observable<HttpResponse<SendContainerProduct[]>> {
        ...
        return this.http.get<SendContainerProduct[]>(this.resourceDayDepotContainerUrl + '/' + dayDepotContainerId + '/send-container-products', { params: options, observe: 'response' })
