...
export class DepotService {
    ...
    findBySellContractCustomer(customerId: number, personId: number, sellContractId: number, contractType: ContractType): Observable<HttpResponse<Depot[]>> {
        let params;
        if (customerId == null) {
        ...
        return this.http.get(this.resourceCustomerUrl + '/person/' + personId + '/sell-contracts/depots', {
            params,
            observe: 'response'
        })
            .map((res: HttpResponse<Depot[]>) => this.convertArrayResponse(res));
