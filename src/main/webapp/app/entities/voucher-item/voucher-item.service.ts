...
export class VoucherItemService {
    ...
    private resourceUrl = SERVER_API_URL + 'niopdcaccounting/api/voucher-items';
    private resourceVoucherMasterUrl = SERVER_API_URL + 'niopdcaccounting/api/voucher-masters';
    ...
    query(req?: any): Observable<HttpResponse<VoucherItem[]>> {
        const options = createRequestOption(req);
        return this.http.get<VoucherItem[]>(this.resourceUrl, {params: options, observe: 'response'})
