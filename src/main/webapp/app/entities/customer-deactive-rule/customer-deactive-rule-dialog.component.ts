...
import {TypeOfFuelReceipt} from "../sell-contract-product/sell-contract-product.model";
...
export class CustomerDeactiveRuleDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.isSaving = false;
        this.customerTypeService.query().subscribe((value: HttpResponse<CustomerType[]>) => {
            this.customertypes = value.body.map((value1: CustomerType) => {
    ...
    ngOnInit() {
        this.routeSub = this.route.params.subscribe((params) => {
            ...
            if (params['id']) {
                ...
                this.customerDeactiveRulePopupService
                    .open(CustomerDeactiveRuleDialogComponent as Component);
            }
        });
    }
