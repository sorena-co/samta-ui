...
export class CustomerDeactiveRuleComponent implements OnInit, OnDestroy {
    ...
    search() {
        this.page = 0;
        this.currentSearch = '';
        if (this.customerDeactiveRule.sellContractCode) {
            this.currentSearch += 'sellContractCode$' + this.customerDeactiveRule.sellContractCode + '&';
        }
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('samtagatewayApp.customerDeactiveRule.home.title').subscribe((title) => {
