...
export class ConsumptionComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        for (const key of x) {
            ...
            if (value.length > 1) {
                this.consumption[value[0]] = value[1];
            }
        }
    }
    ...
    search() {
        this.page = 0;
        this.currentSearch = '';
        if (this.consumption.title) {
            this.currentSearch += 'title$' + this.consumption.title + '&';
        }
        if (this.consumption.code) {
            this.currentSearch += 'code$' + this.consumption.code + '&';
        }
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('samtagatewayApp.consumption.home.title').subscribe((title) => {
