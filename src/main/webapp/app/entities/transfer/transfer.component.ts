...
export class TransferComponent implements OnInit, OnDestroy {
    ...
    constructor(private transferService: TransferService,
        ...
        this._hotkeysService.add(new Hotkey(['ins', 'enter'], (event: KeyboardEvent, k: string): boolean => {
            if (k === 'ins') {
                this.router.navigate(['/', {outlets: {popup: ['transfer-new',this.dayDepotId]}}]);
                return false;
            }
        }));
    }
    ...
    setBreadCrumb() {
        ...
        if (this.mainDayDepotId) {
            ...
            this.translateService.get('samtagatewayApp.transfer.home.mainDayOperationTitle').subscribe((title) => {
                this.breadcrumbItems.push({
        ...
        this.translateService.get('samtagatewayApp.transfer.home.title').subscribe((title) => {
                ...
                .subscribe((res) => {
                    ...
                    this.dayDepotService.find(this.dayDepotId).subscribe(
                        (dayDepot) => {
                            ...
                            if (this.type === 'to') {
                                this.transferTypeService.queryByRefuelCenterAndOilTankType(this.mainDayDepot.refuelCenterId, this.dayDepot.oilTankOilTankType, true).subscribe(
                                    (res) => {
                                        this.transfertypes = res.body;
                                    }
                                );
                            } else {
                                this.transferTypeService.queryByRefuelCenterAndOilTankType(this.mainDayDepot.refuelCenterId, this.dayDepot.oilTankOilTankType, false).subscribe(
                                    (res) => {
                                        this.transfertypes = res.body;
                                    }
                                );
                ...
                .subscribe((res) => {
                    ...
                    this.dayDepotService.find(this.dayDepotId).subscribe(
                        (dayDepot) => {
                            this.dayDepot = dayDepot.body;
                            if (this.type === 'to') {
                                this.transferTypeService.queryByRefuelCenterAndOilTankType(this.mainDayOperation.refuelCenterId, this.dayDepot.oilTankOilTankType, true).subscribe(
                                    (res) => {
                                        this.transfertypes = res.body;
                                    }
                                );
                            } else {
                                this.transferTypeService.queryByRefuelCenterAndOilTankType(this.mainDayOperation.refuelCenterId, this.dayDepot.oilTankOilTankType, false).subscribe(
                                    (res) => {
                                        this.transfertypes = res.body;
                                    }
                                );
