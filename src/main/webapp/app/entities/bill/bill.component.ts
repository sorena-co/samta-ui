...
export class BillComponent implements OnInit, OnDestroy {
    ...
    search() {
        ...
        if (this.bill.customerScore) {
            this.currentSearch += 'customerScore☼' + this.bill.customerScore + '&';
        }
        ...
        if (this.bill.totalPrice) {
            this.currentSearch += 'totalPrice☼' + this.bill.totalPrice + '&';
        }
