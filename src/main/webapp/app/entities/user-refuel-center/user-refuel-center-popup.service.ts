...
export class UserRefuelCenterPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.userRefuelCenterService.find(id)
                    .subscribe((userRefuelCenterResponse: HttpResponse<UserRefuelCenter>) => {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.userRefuelCenterModalRef(component, new UserRefuelCenter());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
