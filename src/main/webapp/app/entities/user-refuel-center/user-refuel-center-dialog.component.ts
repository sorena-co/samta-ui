...
export class UserRefuelCenterDialogComponent implements OnInit {
    ...
    ngOnInit() {
        this.isSaving = false;
        this.userRefuelCenter.username = username.username;
        ...
        this.routeSub = this.route.params.subscribe((params) => {
            if (params['id']) {
                this.userRefuelCenterPopupService
                    .open(UserRefuelCenterDialogComponent as Component, params['id']);
            } else {
                this.userRefuelCenterPopupService
                    .open(UserRefuelCenterDialogComponent as Component);
            }
            if (params['username']) {
