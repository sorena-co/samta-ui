...
export const costRateRoute: Routes = [
    {
        path: 'cost-group/:costGroupId/cost/:costId/cost-rate',
        ...
        data: {
            ...
            pageTitle: 'samtagatewayApp.costRate.home.title'
        },
...
export const costRatePopupRoute: Routes = [
    ...
    {
        path: 'cost-rate/:id/cost/:costId/edit',
        component: CostRatePopupComponent,
        data: {
    ...
    {
        path: 'cost-rate/:id/cost/:costId/:view',
        component: CostRatePopupComponent,
        data: {
