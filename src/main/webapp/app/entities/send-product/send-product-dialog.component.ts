...
export class SendProductDialogComponent implements OnInit {
    ...
    save() {
        ...
        if (this.sendProduct.id !== undefined) {
            ...
            this.subscribeToSaveResponse(
                this.sendProductService.create(this.sendProduct));
        }
    }
    ...
    private subscribeToSaveResponse(result: Observable<HttpResponse<SendProduct>>) {
        result.subscribe((res: HttpResponse<SendProduct>) =>
            this.onSaveSuccess(res.body), (res: HttpErrorResponse) => this.onSaveError());
    }

    private onSaveSuccess(result: SendProduct) {
