...
export const voucherTemplatePopupRoute: Routes = [
    ...
    {
        path: 'voucher-template/:id/delete',
    ...
    {
        path: 'voucher-template/:id/execute-query',
