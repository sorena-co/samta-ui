...
export const currencyRateGroupRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'samtagatewayApp.currencyRateGroup.home.title'
        },
...
export const currencyRateGroupPopupRoute: Routes = [
    ...
    {
        path: 'currency-rate-group/:id/edit',
        component: CurrencyRateGroupPopupComponent,
        data: {
    ...
    {
        path: 'currency-rate-group/:id/delete',
    ...
    {
        path: 'currency-rate-group/:id/:view',
        component: CurrencyRateGroupPopupComponent,
        data: {
