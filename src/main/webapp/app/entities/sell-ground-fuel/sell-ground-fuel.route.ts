...
export const sellGroundFuelRoute: Routes = [
    {
        path: 'main-day-depot/:mainDayDepotId/day-depot/:dayDepotId/sell-ground-fuel',
...
export const sellGroundFuelPopupRoute: Routes = [
    {
        path: 'sell-ground-fuel-new/:dayDepotId',
    ...
    {
        path: 'sell-ground-fuel/:id/delete',
