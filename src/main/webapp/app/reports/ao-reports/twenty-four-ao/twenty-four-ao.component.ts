...
export class TwentyFourAoComponent implements OnInit, OnDestroy {
    ...
    state: State = {take: 10};
    gridData: any = process(this.twentyFourAo, this.state);
    ...
    setBreadCrumb() {
        ...
        this.translateService.get('samtagatewayApp.twentyFourAo.home.title').subscribe((title) => {
    ...
    private onSuccess(data) {
        ...
        this.gridData = process(this.twentyFourAo, this.state);
    }
